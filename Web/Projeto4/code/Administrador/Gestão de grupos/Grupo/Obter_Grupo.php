<HTML>
 ...
 $query_obterDados="SELECT ID_Objetivo, Objetivo, Descrição from cuidador WHERE ID_Cuidador in (SELECT ID_Cuidador from grupo WHERE ID_Monitorizado='$id)";
//apos isso fazer query com select para o grupo onde o where ID_Cuidador é igual à query anterior e o id_monitorizado=$id;
 //Selecionar tudo relacionado com esse cuidador no grupo, se é principal etc
