        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="Gerir de grupos/index.php"><i class="fa fa-circle-o"></i> Gestão dos grupos</a></li>
            </ul>
          </li>
        ...
        <div class="row">
          <div class="col-lg-4 col-xs-6">
            <div class="small-box bg-red">
              <div class="inner">
                <h3><?php echo $contagem_cuidador['conta']; ?></h3>

                <p>Número de cuidadores</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                <h3><?php echo $contagem_monitorizado['conta']; ?></h3>

                <p>Cuidador monitorizados</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                <h3><?php echo $contagem_grupo['conta']; ?></h3>
