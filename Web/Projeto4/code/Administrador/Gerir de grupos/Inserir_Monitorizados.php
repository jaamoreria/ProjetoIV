...
<script src="../../../plugins/jQuery/jquery-2.2.3.min.js"></script>
<script src="Validar/validacao_inserir_monitorizado.js"></script> <!-- Uso de uma validacao manual, verificar disponibilidades de username etc, e verificar se os campos estão vazios, pois o required não funciona com o tipo de botão como "button" (Uso desse tipo para que ao submeter os dados, não fazer refresh inteiro da página, mas apenas parcialmente);-->
