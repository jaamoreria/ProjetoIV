                ...
                <div class="modal-body">
                  <form id="f2" method="POST" action="" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group input-group" id="passwordEdit">
                      ...
                      <label class="control-label" for="editar-passwordEdit" id="vazio-passEdit" style="display:none;"><i class="fa fa-times-circle-o"></i> Campo vazio</label>
                      <div class="input-group-btn">
                        <button type="button" class="btn btn-default" aria-label="Help" id="ver"><span class="glyphicon glyphicon-eye-open"></span></button>
                      </div> 
                    </div>
