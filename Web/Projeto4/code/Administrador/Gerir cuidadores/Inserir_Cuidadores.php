...
<script src="Validar/validacao_inserir_cuidador.js"></script> <!-- Uso de uma validacao manual, verificar disponibilidades de username etc, e verificar se os campos estão vazios, pois o required não funciona com o tipo de botão como "button" (Uso desse tipo para que ao submeter os dados, não fazer refresh inteiro da página, mas apenas parcialmente);-->
