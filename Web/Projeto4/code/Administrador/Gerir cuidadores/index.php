...
if($_SESSION['login_user_tipo']=='Administrador'){
  ...
  <head>
    ...
    <title>Gerir cuidadores-Lista</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="index.php"><i class="fa fa-circle-o"></i> Gestão de cuidadores</a></li>
                <li><a href="../Gerir monitorizados/index.php"><i class="fa fa-circle-o"></i> Gestão de monitorizados</a></li>
                <li><a href="../Gerir de grupos/index.php"><i class="fa fa-circle-o"></i> Gerir de grupos</a></li>
              </ul>
            </li>
            ...
            <div class="col-md-12">       
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <?php include ("Inserir_Cuidadores.php"); ?>
                </div>
                <!-- /.box-header -->

                <?php include("Tabela_Dados_Cuidadores.php"); ?>
