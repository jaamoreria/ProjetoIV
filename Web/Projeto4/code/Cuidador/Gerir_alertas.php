          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="Gerir grupo/"><i class="fa fa-circle-o"></i> Gerir de grupos</a></li>
                <li class="active"><a href="Gerir_alertas.php"><i class="fa fa-circle-o"></i>Gestão alertas</a></li>
              </ul>
            </li>
