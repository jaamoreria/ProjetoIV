  ...
  if(name=="editar"){
    ...
    $.ajax({
      ...
      success:function(data){
        $.scojs_message('Dados editados com sucesso', $.scojs_message.TYPE_OK);  
...
///////////////////////////////////////////Mapa 2 (localizações) ///////////////////////////////////////////////////////////////////////////
$.getScript('mapa_localizacao.js', function()
{
...
if(permissões!="Não"){
  var drawingManager = new google.maps.drawing.DrawingManager({
    ...
    drawingControlOptions: {
      ...
      drawingModes: ['circle']
      //drawingModes: ['polygon', 'circle'] //Poligono está aa funcionar apenas na parte web, na parte android não há verificação se está dentro ou fora dos poligonos, mas apenas dentro dos circulos.
      //adiiconar, editar, eliminar, obter áreas seguras, todas essas funções também estão implementadas para poligonos tal como os circulos
    },
